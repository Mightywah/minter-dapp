const contractAddress = "0x42428F02b765A0C172ae6eEC7c181a1e75A25E1c"; // Replace with your own contract address
const chain = 'polygon'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Pixel Lemurs NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Pixel Lemurs NFT Project is a decentralized, open-source project. Try launching your own NFT Collection by following the incredibly helpful step by step guide on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> codeSTACKr YouTube page.';
